...
**v33.208 응시생 수 삭제(원장 «응시생 몇 명인지는 적지 말고 평균만»)**: 학원 시험 통지서(#schoolcap) `acadRep.c.nLabel` = «응시생 평균 점수»(v33.210 원장 정정 — v33.208 «평균»만으로는 부족; 예전 «응시생 N명 평균»). 선생님용 반 결과판 «응시» 칸은 유지(학부모 전송 없음). 성적통지서(#examcap)는 원래 인원 표기 없음.
