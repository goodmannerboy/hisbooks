...
⚠️ 영역 제목이 없는 PDF 는 영역(유형)이 비어 통지서의 영역별 성취도가 안 나온다 — 정답해설에 «어휘 (1~4번)» 식 제목을 넣으면 채워진다. ⚠️ **«같은 양식»이라도 PDF 내부 배치는 달라질 수 있다 — 새 PDF 가 안 읽히면 `yg_parse.py --dump` 로 줄 묶음부터 볼 것.**
